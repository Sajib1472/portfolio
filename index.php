...
<head>
    ...
    <link rel="shortcut icon" href="image/new_favicon.png" type="image/x-icon">
    <title>Sajib Biswas</title>
</head>
<body>
    <div class="container">
        <!-- HEADER -->
            ...
            <section class="featured-box" id="home">
                <div class="featured-text">
                    ...
                    <div class="social_icons">
                        ...
                        <!-- <div class="icon"><i class="uil uil-facebook-f"></i></i></div> -->
                ...
                <div class="featured-image">
                    <div class="image">
                        <img src="image/myself.png" alt="avatar">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="about-info">
                            ...
                            <p>I am well versed in HTML , CSS and Javascript and other cutting edge frameworks and libraries
                                which allows me to implement interactive features. Additionally I have the experience working
                ...
                <div class="row">
                   <div class="col">
                      <div class="contact-info">
                          ...
                          <p><i class="uil uil-envelope"></i> Email: sajibbiswas2711@gmail.com</p>
                          <p><i class="uil uil-phone"></i> Mobile: 01728394735</p>
                      </div>
                   </div>
                   <div class="col">
        ...
        <footer>
            ...
            <div class="bottom-footer">
                <p>Copyright &copy; <a href="#home" style="text-decoration: none;">Sajib Biswas</a> - All rights reserved</p>
            </div>
        </footer>
    </div>
